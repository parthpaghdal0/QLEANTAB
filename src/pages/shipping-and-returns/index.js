...
import * as Style from "./shipping-and-returns.module.scss"
...
export const query = graphql`
  fragment LangShippingAndReturns on STRAPI_SHIPPING_AND_RETURNS {
    banner {
      heading {
        data {
          heading
  ...
  query {
    en: strapiShippingAndReturns(locale: { eq: "en" }) {
      ...LangShippingAndReturns
    }

    sv: strapiShippingAndReturns(locale: { eq: "sv-SE" }) {
      ...LangShippingAndReturns
    }
  }
`
