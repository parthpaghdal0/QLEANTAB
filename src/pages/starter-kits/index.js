...
export const query = graphql`
  fragment LangStarterSetsPage on STRAPI_STARTER_SETS_PAGE {
    banner {
      heading {
        data {
          heading
  ...
  query {
    en: strapiStarterSetsPage(locale: { eq: "en" }) {
      ...LangStarterSetsPage
    }

    sv: strapiStarterSetsPage(locale: { eq: "sv-SE" }) {
      ...LangStarterSetsPage
    }
  }
`
const StarterSets = ({ data }) => {
